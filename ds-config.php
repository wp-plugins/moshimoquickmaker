...
define('UC_MSM_JSDIR_URL', get_option('siteurl') . '/wp-content/plugins/moshimoquickmaker/js/');
define('UC_MSM_CSSDIR_URL', get_option('siteurl') . '/wp-content/plugins/moshimoquickmaker/css/');
